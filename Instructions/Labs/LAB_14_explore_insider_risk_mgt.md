...
1. Wählen Sie im linken Navigationsbereich von Microsoft 365 Compliance Center **Berechtigungen** aus.

1. Wählen Sie auf der Seite „Berechtigungen und Rollen“ im Compliance Center **Rollen** aus.

1. Geben Sie **Insider-Risiko** in das Suchfeld ein. Wählen Sie dann das Suchsymbol (Lupe) aus.  Beachten Sie die zahlreichen Rollen, die angezeigt werden.  Diese weisen jeweils unterschiedliche Zugriffsebenen auf.  Wählen Sie **Insider-Risikomanagement** aus.
...
1. Vor dem Einrichten einer Richtlinie müssen einige Einstellungen konfiguriert werden.  Wählen Sie auf der Seite „Insider-Risikomanagement“ in der oberen rechten Ecke der Seite das **Zahnradsymbol für die Einstellungen** aus, um auf „Einstellungen für Risiken durch Insider“ zuzugreifen.  
    ...
    1. Erkunden Sie andere Elemente, die in den Einstellungen aufgeführt sind. Einige davon befinden sich in der Vorschau.
...
1. Wählen Sie auf der Insider-Risikomanagement-Übersichtsseite die Registerkarte **Richtlinien** und dann **+ Richtlinie erstellen** aus.  Konfigurieren Sie jede der folgenden Registerkarten für Richtlinien.
    ...
    1. Indikatoren Beachten Sie, dass die bei der vorherigen Aufgabe von Ihnen ausgewählten Indikatoren aktiviert sind.  Scrollen Sie über die Seite, um weitere verfügbare Richtlinienindikatoren und andere Elemente anzuzeigen, die automatisch ausgewählt werden.   „Sequenzerkennung“ ist aktiviert.  Wenn eine Sequenz von Aktivitäten, wie definiert, erkannt wird, deutet dies auf ein größeres Risiko hin.  Bewegen Sie Ihre Maus über das Informationssymbol, um ausführliche Informationen zu erhalten.  Für diese Elemente müssen bestimmte Indikatoren ausgewählt und Geräte integriert werden.  Deaktivieren Sie der Einfachheit halber und weil für diesen Mandanten keine Geräte integriert sind die Option **Alles auswählen**. 
